...
public class Gestion {
    ...
    public HashMap<String, fieldType> structTable(String table, boolean display) throws SQLException {
        ...
        while (cn.getResult().next()) {
            ...
            if (type.equals("integer")) { type = "int4"; }
            if (type.equals("character varying")) { type = "varchar"; }
            if (type.equals("double precision")) { type = "FLOAT8"; }
    ...
    public void displayTable(String table) throws SQLException {
        //public void displayTable(String table) throws SQLException - Affiche le contenu de n'importe quelle table à l’aide de la méthode getMetaData de la classe PreparedStatement.
        Connexion cn = new Connexion();
        cn.connect();
